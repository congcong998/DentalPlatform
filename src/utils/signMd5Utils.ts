...
class SignMd5Utils {
  static sortAsc(jsonObj: Record<string, any>) {
  ...
  static getSign(url: string, requestParams?: Record<string, any>, requestBodyParams?: Record<string, any>) {
  ...
  static parseQueryString(url: string) {
    ...
    if (urlArray && urlArray[1]) {
      ...
      while ((paramResult = paramReg.exec(paramString)) != null) {
        if (this.myIsNaN(paramResult[2] as any)) {
  ...
  static mergeObject(objectOne: Record<string, any>, objectTwo?: Record<string, any>) {
